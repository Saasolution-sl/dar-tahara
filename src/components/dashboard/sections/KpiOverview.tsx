  ...
  return (
    <section>
      ...
      <div className="mt-4 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-6">
        ...
        <StatCard label={c.employeesWorking} value={data.employeesWorking} />
        ...
        <StatCard label={c.openComplaints} value={data.openComplaints} tone={data.openComplaints > 0 ? "warning" : "default"} />
