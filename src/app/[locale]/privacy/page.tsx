...
export default function PrivacyPage() {
  return <LegalPage title="Privacy Policy" updated="Effective 13 July 2026">
    ...
    <p>Some pages load small illustrative images from third parties. Our forms display country flags served by flagcdn.com; the request needed to fetch an image makes your IP address and browser details visible to that provider. No form entries, contact details or account information are sent with it, and these images are used only for display.</p>
    <h2>5. Retention</h2>
