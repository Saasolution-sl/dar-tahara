...
export type PortalCopy = {
  ...
  nav: {
    ...
    invoices: string; payments: string; profile: string; support: string; appointments: string;
  };
  dashboard: {
    ...
    subscriptionSuspended: string; subscriptionsSuspended: string;
    suspendedTitle: string; othersContinue: string;
  ...
  acMaintenance: {
    title: string; addUnit: string; includedBadge: string; addonPriceLabel: string;
    maintenanceThisYear: string; nextMaintenanceAvailable: string; nextWindowFrom: string;
    bookMaintenance: string; viewHistory: string; noUnitsTitle: string; noUnitsBody: string;
    registerCta: string; noAcAtProperty: string;
    modalTitle: string; roomLabel: string; roomLabelOther: string; floorLabel: string; brandLabel: string;
    modelLabel: string; serialLabel: string; notesLabel: string;
    roomTypes: Record<string, string>;
    submit: string; submitting: string; success: string; cancel: string;
    selectIncludedPrompt: string; selectIncluded: string; includedConfirmed: string;
    bookModalTitle: string; bookSubmit: string; bookSubmitting: string; bookSuccess: string;
    statusRetired: string; statusReplaced: string;
    errors: Record<string, string>;
  };
  appointments: {
    title: string; upcoming: string; past: string; month: string; agenda: string;
    today: string; previous: string; next: string;
    empty: string; emptyUpcoming: string; emptyPast: string;
    allProperties: string; allStatuses: string; filterProperty: string; filterStatus: string;
    apply: string; clear: string;
    windowLabel: string; windowNote: string; scheduledFor: string; timeToBeConfirmed: string;
    reference: string; property: string; assignedTeam: string; teamMember: string;
    notes: string; backToList: string; details: string;
    reportTitle: string; reportPending: string;
    nextTitle: string; viewAgenda: string;
    blockedNote: string; forfeitedNote: string;
    states: {
      planning: string; confirmed: string; in_progress: string;
      completed: string; cancelled: string; awaiting_update: string;
      suspended: string; forfeited: string;
    };
  };
};
...
const en: PortalCopy = {
  ...
  invoices: {
    ...
    suspensionTermsNote: "Your subscription continues to run during suspension and is still billed. Any cleaning that falls due while payment is outstanding is forfeited and is not rescheduled once payment is received.",
  ...
  acMaintenance: {
    ...
    addUnit: "Add air-conditioning unit",
    includedBadge: "Included with subscription",
    addonPriceLabel: "€4.00/month",
    maintenanceThisYear: "Maintenance this year: {completed} of {total} completed",
    nextMaintenanceAvailable: "Maintenance available now",
    nextWindowFrom: "Your next maintenance window starts {date}.",
    bookMaintenance: "Book maintenance",
    viewHistory: "View maintenance history",
    noUnitsTitle: "Register your included air conditioner",
    noUnitsBody: "Your subscription includes maintenance cleaning for one air-conditioning unit, up to twice per 12-month benefit period.",
    registerCta: "Register my AC",
    noAcAtProperty: "No air conditioning at this property",
    modalTitle: "Register an air conditioner",
    roomLabel: "Room / space",
    roomLabelOther: "Describe the room or location",
    ...
    success: "Your air conditioner has been registered.",
    cancel: "Cancel",
    selectIncludedPrompt: "Choose which air-conditioning unit is included with your subscription.",
    selectIncluded: "Include with subscription",
    includedConfirmed: "Maintenance: up to 2 times per 12 months, included in your subscription",
    bookModalTitle: "Book AC maintenance",
    bookSubmit: "Book maintenance",
    bookSubmitting: "Booking…",
    bookSuccess: "Your maintenance visit has been booked.",
    statusRetired: "Retired",
    statusReplaced: "Replaced",
    errors: {
      ac_unit_not_active: "This air conditioner is not currently active.",
      ac_unit_property_mismatch: "This air conditioner does not belong to this property.",
      entitlement_not_available: "This maintenance visit has already been used or booked.",
      entitlement_ac_unit_mismatch: "This maintenance visit belongs to a different air conditioner.",
      subscription_not_active: "Your subscription is not currently active.",
      service_window_not_open: "This maintenance window is not open yet.",
      invalid_room_type: "Please choose a room or space.",
      room_label_required: "Please describe the room or location.",
      included_unit_already_selected: "An included air conditioner is already selected for this subscription.",
      no_subscription_for_property: "No active subscription was found for this property.",
      bad_request: "Something went wrong. Please try again.",
    },
  },
  appointments: {
    ...
    previous: "Previous",
    next: "Next",
    empty: "You do not have any cleaning appointments yet.",
    emptyUpcoming: "No upcoming appointments are scheduled.",
    emptyPast: "No past appointments to show.",
    ...
    apply: "Apply filters",
    clear: "Clear filters",
    windowLabel: "Service window",
    windowNote: "Your cleaning takes place within this week. The exact time is confirmed closer to the date.",
    ...
    reportPending: "The cleaning report will become available after the appointment has been completed and reviewed.",
    nextTitle: "Next appointment",
    viewAgenda: "View agenda",
    blockedNote: "Scheduling is on hold while a subscription payment is outstanding. Settle the invoice and your appointments resume.",
    forfeitedNote: "This visit fell due while the invoice was unpaid, so the turn was forfeited. It is not rescheduled once payment is received.",
    states: {
      planning: "To be scheduled",
      confirmed: "Confirmed",
      in_progress: "In progress",
      completed: "Completed",
      cancelled: "Cancelled",
      awaiting_update: "Awaiting update",
      suspended: "Suspended due to open invoice",
      forfeited: "Forfeited, invoice unpaid",
    },
  },
};
...
export const portalCopy: Record<Locale, PortalCopy> = {
  en,
  nl: { language:"Taal", auth:{login:"Inloggen",email:"E-mailadres",password:"Wachtwoord",forgot:"Wachtwoord vergeten?",signIn:"Inloggen",signingIn:"Bezig met inloggen…",invalid:"Het e-mailadres of wachtwoord is onjuist.",resetTitle:"Wachtwoord herstellen",resetIntro:"Vul uw e-mailadres in voor veilige herstelinstructies.",sendReset:"Herstellink versturen",resetSent:"Als het account bestaat, zijn instructies verstuurd.",newPassword:"Nieuw wachtwoord",savePassword:"Nieuw wachtwoord opslaan",passwordSaved:"Uw wachtwoord is bijgewerkt.",passwordTooShort:"Gebruik minimaal 12 tekens.",passwordWeak:"Kies een sterker, uniek wachtwoord dat niet in een bekend datalek voorkomt.",passwordSame:"Kies een ander wachtwoord dan uw huidige wachtwoord.",resetLinkInvalid:"Deze herstellink is ongeldig of verlopen. Vraag een nieuwe aan.",passwordUpdateFailed:"Het wachtwoord kon niet worden bijgewerkt. Probeer het opnieuw.",logout:"Uitloggen",createAccount:"Account aanmaken",signupIntro:"Kies de snelste manier om uw beveiligde Dar Tahara-account aan te maken.",noAccount:"Nieuw bij Dar Tahara?",haveAccount:"Heeft u al een account?",continueGoogle:"Doorgaan met Google",continueApple:"Doorgaan met Apple",redirecting:"Doorsturen…",orEmail:"of gebruik e-mail",oauthFailed:"We konden niet doorgaan met deze aanbieder. Probeer het opnieuw.",creatingAccount:"Account aanmaken…",passwordHint:"Gebruik minimaal 12 tekens. U ontvangt per e-mail een bevestigingslink.",signupFailed:"Het account kon niet worden aangemaakt. Probeer het opnieuw of log in.",checkEmailTitle:"Controleer uw e-mail",checkEmail:"Open de bevestigingslink die we u hebben gestuurd om uw e-mailadres te verifiëren en uw account af te ronden.",backToLogin:"Terug naar inloggen",agreement:"Door verder te gaan, gaat u akkoord met de",terms:"Voorwaarden",and:"en het",privacy:"Privacybeleid",registrationUnavailable:"Accountregistratie is tijdelijk niet beschikbaar. Probeer het later opnieuw."}, nav:{overview:"Overzicht",assessments:"Beoordelingen",properties:"Woningen",subscriptions:"Abonnementen",invoices:"Facturen",payments:"Betalingen",profile:"Profiel",support:"Ondersteuning",appointments:"Afspraken"}, appointments:{forfeitedNote:"Deze beurt viel terwijl de factuur openstond en is daarmee vervallen. Zij wordt na betaling niet ingehaald.",title:"Afspraken",upcoming:"Aankomend",past:"Afgelopen",month:"Maand",agenda:"Agenda",today:"Vandaag",previous:"Vorige",next:"Volgende",empty:"U heeft nog geen schoonmaakafspraken.",emptyUpcoming:"Er zijn geen aankomende afspraken gepland.",emptyPast:"Geen afgelopen afspraken om te tonen.",allProperties:"Alle woningen",allStatuses:"Alle statussen",filterProperty:"Woning",filterStatus:"Status",apply:"Filters toepassen",clear:"Filters wissen",windowLabel:"Serviceperiode",windowNote:"Uw schoonmaak vindt binnen deze week plaats. Het exacte tijdstip wordt dichter bij de datum bevestigd.",scheduledFor:"Gepland op",timeToBeConfirmed:"Tijdstip wordt nog bevestigd",reference:"Referentie",property:"Woning",assignedTeam:"Toegewezen team",teamMember:"Medewerker",notes:"Opmerkingen",backToList:"Terug naar afspraken",details:"Afspraakgegevens",reportTitle:"Schoonmaakrapport",reportPending:"Het schoonmaakrapport is beschikbaar zodra de afspraak is voltooid en gecontroleerd.",nextTitle:"Volgende afspraak",viewAgenda:"Agenda bekijken",blockedNote:"Het inplannen ligt stil zolang een abonnementsbetaling openstaat. Voldoe de factuur en uw afspraken worden hervat.",states:{planning:"Nog in te plannen",confirmed:"Bevestigd",in_progress:"Bezig",completed:"Voltooid",cancelled:"Geannuleerd",awaiting_update:"Wacht op update",suspended:"Opgeschort wegens openstaande factuur",forfeited:"Vervallen, factuur onbetaald"}}, dashboard:{...en.dashboard,suspendedTitle:"Opgeschorte abonnementen",othersContinue:"Uw overige abonnementen zijn niet getroffen en lopen gewoon door.",subscriptionSuspended:"{count} abonnement opgeschort tot betaling",subscriptionsSuspended:"{count} abonnementen opgeschort tot betaling",payNow:"Nu betalen",title:"Mijn account",welcome:"Welkom terug",accountStatus:"Accountstatus",property:"Woning",subscription:"Abonnement",nextPayment:"Volgende betaling",balance:"Openstaand saldo",latestInvoice:"Laatste factuur",upcomingService:"Volgende service",activity:"Recente activiteit",empty:"Nog niets om te tonen.",download:"Downloaden",reference:"Referentie",submitted:"Ingediend",status:"Status",address:"Adres",frequency:"Frequentie",amount:"Bedrag",date:"Datum",due:"Vervaldatum",paid:"Betaald",contactSupport:"Contact opnemen"}, pause:{...en.pause}, deepClean:{...en.deepClean}, acMaintenance:{...en.acMaintenance}, properties:{...en.properties}, invoices:{...en.invoices,payNow:"Nu betalen",suspensionTermsNote:"Uw abonnement loopt tijdens de opschorting gewoon door en wordt nog steeds gefactureerd. Een schoonmaakbeurt die valt terwijl de betaling openstaat, vervalt en wordt na betaling niet ingehaald."}, cancellation:{...en.cancellation} },
  fr: { language:"Langue", auth:{login:"Connexion",email:"Adresse e-mail",password:"Mot de passe",forgot:"Mot de passe oublié ?",signIn:"Se connecter",signingIn:"Connexion…",invalid:"L’adresse e-mail ou le mot de passe est incorrect.",resetTitle:"Réinitialiser le mot de passe",resetIntro:"Saisissez votre e-mail pour recevoir des instructions sécurisées.",sendReset:"Envoyer le lien",resetSent:"Si le compte existe, les instructions ont été envoyées.",newPassword:"Nouveau mot de passe",savePassword:"Enregistrer",passwordSaved:"Votre mot de passe a été mis à jour.",passwordTooShort:"Utilisez au moins 12 caractères.",resetLinkInvalid:"Ce lien est invalide ou expiré. Demandez-en un nouveau.",passwordUpdateFailed:"Le mot de passe n’a pas pu être mis à jour. Réessayez.",logout:"Déconnexion",createAccount:"Créer un compte",signupIntro:"Choisissez le moyen le plus rapide de créer votre compte Dar Tahara sécurisé.",noAccount:"Nouveau chez Dar Tahara ?",haveAccount:"Vous avez déjà un compte ?",continueGoogle:"Continuer avec Google",continueApple:"Continuer avec Apple",redirecting:"Redirection…",orEmail:"ou utiliser l’e-mail",oauthFailed:"Impossible de continuer avec ce fournisseur. Veuillez réessayer.",creatingAccount:"Création du compte…",passwordHint:"Utilisez au moins 12 caractères. Un lien de confirmation vous sera envoyé par e-mail.",signupFailed:"Le compte n’a pas pu être créé. Réessayez ou connectez-vous.",checkEmailTitle:"Consultez votre e-mail",checkEmail:"Ouvrez le lien de confirmation envoyé pour vérifier votre adresse e-mail et terminer la création du compte.",backToLogin:"Retour à la connexion",agreement:"En continuant, vous acceptez les",terms:"Conditions",and:"et la",privacy:"Politique de confidentialité",registrationUnavailable:"La création de compte est temporairement indisponible. Réessayez plus tard."}, nav:{overview:"Aperçu",assessments:"Évaluations",properties:"Propriétés",subscriptions:"Abonnements",invoices:"Factures",payments:"Paiements",profile:"Profil",support:"Assistance",appointments:"Rendez-vous"}, appointments:{forfeitedNote:"Cette intervention est arrivée à échéance alors que la facture était impayée : le tour est perdu et n’est pas reprogrammé après paiement.",title:"Rendez-vous",upcoming:"À venir",past:"Passés",month:"Mois",agenda:"Agenda",today:"Aujourd’hui",previous:"Précédent",next:"Suivant",empty:"Vous n’avez pas encore de rendez-vous de nettoyage.",emptyUpcoming:"Aucun rendez-vous à venir n’est planifié.",emptyPast:"Aucun rendez-vous passé à afficher.",allProperties:"Toutes les propriétés",allStatuses:"Tous les statuts",filterProperty:"Propriété",filterStatus:"Statut",apply:"Appliquer les filtres",clear:"Effacer les filtres",windowLabel:"Période de service",windowNote:"Votre nettoyage a lieu au cours de cette semaine. L’heure exacte est confirmée à l’approche de la date.",scheduledFor:"Planifié le",timeToBeConfirmed:"Heure à confirmer",reference:"Référence",property:"Propriété",assignedTeam:"Équipe assignée",teamMember:"Membre de l’équipe",notes:"Remarques",backToList:"Retour aux rendez-vous",details:"Détails du rendez-vous",reportTitle:"Rapport de nettoyage",reportPending:"Le rapport de nettoyage sera disponible une fois le rendez-vous terminé et contrôlé.",nextTitle:"Prochain rendez-vous",viewAgenda:"Voir l’agenda",blockedNote:"La planification est suspendue tant qu’un paiement d’abonnement est en attente. Réglez la facture et vos rendez-vous reprendront.",states:{planning:"À planifier",confirmed:"Confirmé",in_progress:"En cours",completed:"Terminé",cancelled:"Annulé",awaiting_update:"En attente de mise à jour",suspended:"Suspendu pour facture impayée",forfeited:"Perdu, facture impayée"}}, dashboard:{...en.dashboard,suspendedTitle:"Abonnements suspendus",othersContinue:"Vos autres abonnements ne sont pas concernés et se poursuivent normalement.",subscriptionSuspended:"{count} abonnement suspendu jusqu’au paiement",subscriptionsSuspended:"{count} abonnements suspendus jusqu’au paiement",payNow:"Payer maintenant",title:"Mon compte",welcome:"Bienvenue",accountStatus:"Statut du compte",property:"Propriété",subscription:"Abonnement",nextPayment:"Prochain paiement",balance:"Solde dû",latestInvoice:"Dernière facture",upcomingService:"Prochain service",activity:"Activité récente",empty:"Aucune donnée pour le moment.",download:"Télécharger",reference:"Référence",submitted:"Soumis",status:"Statut",address:"Adresse",frequency:"Fréquence",amount:"Montant",date:"Date",due:"Échéance",paid:"Payé",contactSupport:"Contacter l’assistance"}, pause:{...en.pause}, deepClean:{...en.deepClean}, acMaintenance:{...en.acMaintenance}, properties:{...en.properties}, invoices:{...en.invoices,payNow:"Payer maintenant",suspensionTermsNote:"Votre abonnement continue pendant la suspension et reste facturé. Tout nettoyage prévu pendant que le paiement est en attente est perdu et n’est pas reprogrammé après le paiement."}, cancellation:{...en.cancellation} },
  ar: { language:"اللغة", auth:{login:"تسجيل الدخول",email:"البريد الإلكتروني",password:"كلمة المرور",forgot:"نسيت كلمة المرور؟",signIn:"دخول",signingIn:"جارٍ الدخول…",invalid:"البريد الإلكتروني أو كلمة المرور غير صحيحة.",resetTitle:"إعادة تعيين كلمة المرور",resetIntro:"أدخل بريدك لإرسال تعليمات آمنة.",sendReset:"إرسال رابط الاستعادة",resetSent:"إذا كان الحساب موجودًا فقد أُرسلت التعليمات.",newPassword:"كلمة مرور جديدة",savePassword:"حفظ كلمة المرور",passwordSaved:"تم تحديث كلمة المرور.",passwordTooShort:"استخدم 12 حرفًا على الأقل.",resetLinkInvalid:"رابط إعادة التعيين غير صالح أو منتهي. اطلب رابطًا جديدًا.",passwordUpdateFailed:"تعذر تحديث كلمة المرور. حاول مرة أخرى.",logout:"تسجيل الخروج",createAccount:"إنشاء حساب",signupIntro:"اختر أسرع طريقة لإنشاء حسابك الآمن في دار طهارة.",noAccount:"جديد في دار طهارة؟",haveAccount:"لديك حساب بالفعل؟",continueGoogle:"المتابعة باستخدام Google",continueApple:"المتابعة باستخدام Apple",redirecting:"جارٍ التحويل…",orEmail:"أو استخدم البريد الإلكتروني",oauthFailed:"تعذر المتابعة مع مزود الخدمة هذا. حاول مرة أخرى.",creatingAccount:"جارٍ إنشاء الحساب…",passwordHint:"استخدم 12 حرفًا على الأقل. سنرسل رابط تأكيد إلى بريدك الإلكتروني.",signupFailed:"تعذر إنشاء الحساب. حاول مرة أخرى أو سجّل الدخول.",checkEmailTitle:"تحقق من بريدك الإلكتروني",checkEmail:"افتح رابط التأكيد الذي أرسلناه للتحقق من بريدك الإلكتروني وإكمال إنشاء حسابك.",backToLogin:"العودة إلى تسجيل الدخول",agreement:"بالمتابعة، أنت توافق على",terms:"الشروط",and:"و",privacy:"سياسة الخصوصية",registrationUnavailable:"إنشاء الحساب غير متاح مؤقتًا. حاول مرة أخرى لاحقًا."}, nav:{overview:"نظرة عامة",assessments:"التقييمات",properties:"العقارات",subscriptions:"الاشتراكات",invoices:"الفواتير",payments:"المدفوعات",profile:"الملف الشخصي",support:"الدعم",appointments:"المواعيد"}, appointments:{forfeitedNote:"حان موعد هذه الزيارة والفاتورة غير مسددة، لذلك سقط الدور ولا تتم إعادة جدولته بعد السداد.",title:"المواعيد",upcoming:"القادمة",past:"السابقة",month:"شهر",agenda:"جدول الأعمال",today:"اليوم",previous:"السابق",next:"التالي",empty:"ليس لديك أي مواعيد تنظيف حتى الآن.",emptyUpcoming:"لا توجد مواعيد قادمة مجدولة.",emptyPast:"لا توجد مواعيد سابقة لعرضها.",allProperties:"جميع العقارات",allStatuses:"جميع الحالات",filterProperty:"العقار",filterStatus:"الحالة",apply:"تطبيق عوامل التصفية",clear:"مسح عوامل التصفية",windowLabel:"فترة الخدمة",windowNote:"يتم التنظيف خلال هذا الأسبوع. يُؤكَّد الوقت المحدد مع اقتراب الموعد.",scheduledFor:"مجدول في",timeToBeConfirmed:"سيتم تأكيد الوقت",reference:"الرقم المرجعي",property:"العقار",assignedTeam:"الفريق المكلَّف",teamMember:"عضو الفريق",notes:"ملاحظات",backToList:"العودة إلى المواعيد",details:"تفاصيل الموعد",reportTitle:"تقرير التنظيف",reportPending:"سيصبح تقرير التنظيف متاحًا بعد اكتمال الموعد ومراجعته.",nextTitle:"الموعد القادم",viewAgenda:"عرض جدول الأعمال",blockedNote:"تم إيقاف الجدولة مؤقتًا بسبب وجود دفعة اشتراك غير مسددة. سدِّد الفاتورة وستُستأنف مواعيدك.",states:{planning:"بانتظار الجدولة",confirmed:"مؤكَّد",in_progress:"قيد التنفيذ",completed:"مكتمل",cancelled:"ملغى",awaiting_update:"بانتظار التحديث",suspended:"موقوف بسبب فاتورة غير مسددة",forfeited:"ساقط، فاتورة غير مسددة"}}, dashboard:{...en.dashboard,suspendedTitle:"الاشتراكات الموقوفة",othersContinue:"اشتراكاتك الأخرى غير متأثرة وتستمر كالمعتاد.",subscriptionSuspended:"{count} اشتراك موقوف حتى السداد",subscriptionsSuspended:"{count} اشتراكات موقوفة حتى السداد",payNow:"ادفع الآن",title:"حسابي",welcome:"مرحبًا بعودتك",accountStatus:"حالة الحساب",property:"العقار",subscription:"الاشتراك",nextPayment:"الدفعة التالية",balance:"الرصيد المستحق",latestInvoice:"أحدث فاتورة",upcomingService:"الخدمة القادمة",activity:"النشاط الأخير",empty:"لا توجد بيانات بعد.",download:"تنزيل",reference:"المرجع",submitted:"تاريخ التقديم",status:"الحالة",address:"العنوان",frequency:"التكرار",amount:"المبلغ",date:"التاريخ",due:"الاستحقاق",paid:"مدفوع",contactSupport:"اتصل بالدعم"}, pause:{...en.pause}, deepClean:{...en.deepClean}, acMaintenance:{...en.acMaintenance}, properties:{...en.properties}, invoices:{...en.invoices,payNow:"ادفع الآن",suspensionTermsNote:"يستمر اشتراكك أثناء الإيقاف المؤقت وتستمر الفوترة. أي تنظيف يحين موعده أثناء وجود دفعة غير مسددة يسقط ولا تتم إعادة جدولته بعد السداد."}, cancellation:{...en.cancellation} },
  es: { language:"Idioma", auth:{login:"Iniciar sesión",email:"Correo electrónico",password:"Contraseña",forgot:"¿Olvidó la contraseña?",signIn:"Entrar",signingIn:"Iniciando sesión…",invalid:"El correo o la contraseña son incorrectos.",resetTitle:"Restablecer contraseña",resetIntro:"Introduzca su correo para recibir instrucciones seguras.",sendReset:"Enviar enlace",resetSent:"Si la cuenta existe, se han enviado instrucciones.",newPassword:"Nueva contraseña",savePassword:"Guardar contraseña",passwordSaved:"Su contraseña se ha actualizado.",passwordTooShort:"Utilice al menos 12 caracteres.",resetLinkInvalid:"Este enlace no es válido o ha caducado. Solicite uno nuevo.",passwordUpdateFailed:"No se pudo actualizar la contraseña. Inténtelo de nuevo.",logout:"Cerrar sesión",createAccount:"Crear cuenta",signupIntro:"Elige la forma más rápida de crear tu cuenta segura de Dar Tahara.",noAccount:"¿Nuevo en Dar Tahara?",haveAccount:"¿Ya tienes una cuenta?",continueGoogle:"Continuar con Google",continueApple:"Continuar con Apple",redirecting:"Redirigiendo…",orEmail:"o usa el correo",oauthFailed:"No pudimos continuar con ese proveedor. Inténtalo de nuevo.",creatingAccount:"Creando cuenta…",passwordHint:"Usa al menos 12 caracteres. Enviaremos un enlace de confirmación a tu correo.",signupFailed:"No pudimos crear la cuenta. Inténtalo de nuevo o inicia sesión.",checkEmailTitle:"Revisa tu correo",checkEmail:"Abre el enlace de confirmación que te enviamos para verificar tu correo y terminar de crear tu cuenta.",backToLogin:"Volver al inicio de sesión",agreement:"Al continuar, aceptas los",terms:"Términos",and:"y la",privacy:"Política de privacidad",registrationUnavailable:"El registro de cuentas no está disponible temporalmente. Inténtalo más tarde."}, nav:{overview:"Resumen",assessments:"Evaluaciones",properties:"Propiedades",subscriptions:"Suscripciones",invoices:"Facturas",payments:"Pagos",profile:"Perfil",support:"Soporte",appointments:"Citas"}, appointments:{forfeitedNote:"Esta visita venció mientras la factura estaba impagada, por lo que el turno se pierde y no se reprograma tras el pago.",title:"Citas",upcoming:"Próximas",past:"Anteriores",month:"Mes",agenda:"Agenda",today:"Hoy",previous:"Anterior",next:"Siguiente",empty:"Todavía no tiene citas de limpieza.",emptyUpcoming:"No hay citas próximas programadas.",emptyPast:"No hay citas anteriores que mostrar.",allProperties:"Todas las propiedades",allStatuses:"Todos los estados",filterProperty:"Propiedad",filterStatus:"Estado",apply:"Aplicar filtros",clear:"Borrar filtros",windowLabel:"Periodo de servicio",windowNote:"Su limpieza se realiza durante esta semana. La hora exacta se confirma cerca de la fecha.",scheduledFor:"Programada para",timeToBeConfirmed:"Hora por confirmar",reference:"Referencia",property:"Propiedad",assignedTeam:"Equipo asignado",teamMember:"Miembro del equipo",notes:"Notas",backToList:"Volver a las citas",details:"Detalles de la cita",reportTitle:"Informe de limpieza",reportPending:"El informe de limpieza estará disponible una vez que la cita se haya completado y revisado.",nextTitle:"Próxima cita",viewAgenda:"Ver agenda",blockedNote:"La programación está en pausa mientras haya un pago de suscripción pendiente. Liquide la factura y sus citas se reanudarán.",states:{planning:"Pendiente de programar",confirmed:"Confirmada",in_progress:"En curso",completed:"Completada",cancelled:"Cancelada",awaiting_update:"Pendiente de actualización",suspended:"Suspendida por factura pendiente",forfeited:"Perdida, factura impagada"}}, dashboard:{...en.dashboard,suspendedTitle:"Suscripciones suspendidas",othersContinue:"Sus demás suscripciones no se ven afectadas y continúan con normalidad.",subscriptionSuspended:"{count} suscripción suspendida hasta el pago",subscriptionsSuspended:"{count} suscripciones suspendidas hasta el pago",payNow:"Pagar ahora",title:"Mi cuenta",welcome:"Bienvenido de nuevo",accountStatus:"Estado de la cuenta",property:"Propiedad",subscription:"Suscripción",nextPayment:"Próximo pago",balance:"Saldo pendiente",latestInvoice:"Última factura",upcomingService:"Próximo servicio",activity:"Actividad reciente",empty:"Aún no hay datos.",download:"Descargar",reference:"Referencia",submitted:"Enviado",status:"Estado",address:"Dirección",frequency:"Frecuencia",amount:"Importe",date:"Fecha",due:"Vence",paid:"Pagado",contactSupport:"Contactar soporte"}, pause:{...en.pause}, deepClean:{...en.deepClean}, acMaintenance:{...en.acMaintenance}, properties:{...en.properties}, invoices:{...en.invoices,payNow:"Pagar ahora",suspensionTermsNote:"Su suscripción sigue vigente durante la suspensión y se sigue facturando. Cualquier limpieza que corresponda mientras el pago esté pendiente se pierde y no se reprograma una vez recibido el pago."}, cancellation:{...en.cancellation} },
  de: { language:"Sprache", auth:{login:"Anmelden",email:"E-Mail-Adresse",password:"Passwort",forgot:"Passwort vergessen?",signIn:"Anmelden",signingIn:"Anmeldung…",invalid:"E-Mail oder Passwort ist falsch.",resetTitle:"Passwort zurücksetzen",resetIntro:"Geben Sie Ihre E-Mail für sichere Anweisungen ein.",sendReset:"Link senden",resetSent:"Falls das Konto existiert, wurden Anweisungen gesendet.",newPassword:"Neues Passwort",savePassword:"Passwort speichern",passwordSaved:"Ihr Passwort wurde aktualisiert.",passwordTooShort:"Verwenden Sie mindestens 12 Zeichen.",resetLinkInvalid:"Dieser Link ist ungültig oder abgelaufen. Fordern Sie einen neuen an.",passwordUpdateFailed:"Das Passwort konnte nicht aktualisiert werden. Versuchen Sie es erneut.",logout:"Abmelden",createAccount:"Konto erstellen",signupIntro:"Wählen Sie den schnellsten Weg zu Ihrem sicheren Dar-Tahara-Konto.",noAccount:"Neu bei Dar Tahara?",haveAccount:"Sie haben bereits ein Konto?",continueGoogle:"Weiter mit Google",continueApple:"Weiter mit Apple",redirecting:"Weiterleitung…",orEmail:"oder E-Mail verwenden",oauthFailed:"Mit diesem Anbieter konnte nicht fortgefahren werden. Versuchen Sie es erneut.",creatingAccount:"Konto wird erstellt…",passwordHint:"Verwenden Sie mindestens 12 Zeichen. Sie erhalten einen Bestätigungslink per E-Mail.",signupFailed:"Das Konto konnte nicht erstellt werden. Versuchen Sie es erneut oder melden Sie sich an.",checkEmailTitle:"Prüfen Sie Ihre E-Mail",checkEmail:"Öffnen Sie den gesendeten Bestätigungslink, um Ihre E-Mail zu verifizieren und die Kontoerstellung abzuschließen.",backToLogin:"Zurück zur Anmeldung",agreement:"Wenn Sie fortfahren, stimmen Sie den",terms:"Bedingungen",and:"und der",privacy:"Datenschutzerklärung",registrationUnavailable:"Die Kontoregistrierung ist vorübergehend nicht verfügbar. Versuchen Sie es später erneut."}, nav:{overview:"Übersicht",assessments:"Bewertungen",properties:"Immobilien",subscriptions:"Abonnements",invoices:"Rechnungen",payments:"Zahlungen",profile:"Profil",support:"Support",appointments:"Termine"}, appointments:{forfeitedNote:"Dieser Termin wurde fällig, während die Rechnung offen war; der Turnus verfällt und wird nach Zahlung nicht nachgeholt.",title:"Termine",upcoming:"Bevorstehend",past:"Vergangen",month:"Monat",agenda:"Agenda",today:"Heute",previous:"Zurück",next:"Weiter",empty:"Sie haben noch keine Reinigungstermine.",emptyUpcoming:"Es sind keine bevorstehenden Termine geplant.",emptyPast:"Keine vergangenen Termine vorhanden.",allProperties:"Alle Immobilien",allStatuses:"Alle Status",filterProperty:"Immobilie",filterStatus:"Status",apply:"Filter anwenden",clear:"Filter zurücksetzen",windowLabel:"Servicezeitraum",windowNote:"Ihre Reinigung findet innerhalb dieser Woche statt. Die genaue Uhrzeit wird näher am Termin bestätigt.",scheduledFor:"Geplant für",timeToBeConfirmed:"Uhrzeit wird noch bestätigt",reference:"Referenz",property:"Immobilie",assignedTeam:"Zugewiesenes Team",teamMember:"Teammitglied",notes:"Anmerkungen",backToList:"Zurück zu den Terminen",details:"Termindetails",reportTitle:"Reinigungsbericht",reportPending:"Der Reinigungsbericht wird verfügbar, sobald der Termin abgeschlossen und geprüft wurde.",nextTitle:"Nächster Termin",viewAgenda:"Agenda ansehen",blockedNote:"Die Terminplanung pausiert, solange eine Abonnementzahlung offen ist. Begleichen Sie die Rechnung, dann werden Ihre Termine fortgesetzt.",states:{planning:"Noch zu planen",confirmed:"Bestätigt",in_progress:"In Bearbeitung",completed:"Abgeschlossen",cancelled:"Storniert",awaiting_update:"Aktualisierung ausstehend",suspended:"Wegen offener Rechnung ausgesetzt",forfeited:"Verfallen, Rechnung offen"}}, dashboard:{...en.dashboard,suspendedTitle:"Ausgesetzte Abonnements",othersContinue:"Ihre übrigen Abonnements sind nicht betroffen und laufen normal weiter.",subscriptionSuspended:"{count} Abonnement bis zur Zahlung ausgesetzt",subscriptionsSuspended:"{count} Abonnements bis zur Zahlung ausgesetzt",payNow:"Jetzt bezahlen",title:"Mein Konto",welcome:"Willkommen zurück",accountStatus:"Kontostatus",property:"Immobilie",subscription:"Abonnement",nextPayment:"Nächste Zahlung",balance:"Offener Betrag",latestInvoice:"Letzte Rechnung",upcomingService:"Nächster Service",activity:"Letzte Aktivitäten",empty:"Noch keine Daten.",download:"Herunterladen",reference:"Referenz",submitted:"Eingereicht",status:"Status",address:"Adresse",frequency:"Häufigkeit",amount:"Betrag",date:"Datum",due:"Fällig",paid:"Bezahlt",contactSupport:"Support kontaktieren"}, pause:{...en.pause}, deepClean:{...en.deepClean}, acMaintenance:{...en.acMaintenance}, properties:{...en.properties}, invoices:{...en.invoices,payNow:"Jetzt bezahlen",suspensionTermsNote:"Ihr Abonnement läuft während der Aussetzung weiter und wird weiterhin berechnet. Jede Reinigung, die während einer offenen Zahlung fällig wird, verfällt und wird nach Zahlungseingang nicht nachgeholt."}, cancellation:{...en.cancellation} },
  pt: { language:"Idioma", auth:{login:"Iniciar sessão",email:"E-mail",password:"Palavra-passe",forgot:"Esqueceu a palavra-passe?",signIn:"Entrar",signingIn:"A iniciar…",invalid:"O e-mail ou a palavra-passe está incorreto.",resetTitle:"Repor palavra-passe",resetIntro:"Introduza o e-mail para receber instruções seguras.",sendReset:"Enviar ligação",resetSent:"Se a conta existir, as instruções foram enviadas.",newPassword:"Nova palavra-passe",savePassword:"Guardar palavra-passe",passwordSaved:"A palavra-passe foi atualizada.",passwordTooShort:"Utilize pelo menos 12 caracteres.",resetLinkInvalid:"Esta ligação é inválida ou expirou. Solicite uma nova.",passwordUpdateFailed:"Não foi possível atualizar a palavra-passe. Tente novamente.",logout:"Terminar sessão",createAccount:"Criar conta",signupIntro:"Escolha a forma mais rápida de criar a sua conta Dar Tahara segura.",noAccount:"Novo na Dar Tahara?",haveAccount:"Já tem uma conta?",continueGoogle:"Continuar com Google",continueApple:"Continuar com Apple",redirecting:"A redirecionar…",orEmail:"ou utilize o e-mail",oauthFailed:"Não foi possível continuar com esse fornecedor. Tente novamente.",creatingAccount:"A criar conta…",passwordHint:"Utilize pelo menos 12 caracteres. Enviaremos uma ligação de confirmação para o seu e-mail.",signupFailed:"Não foi possível criar a conta. Tente novamente ou inicie sessão.",checkEmailTitle:"Verifique o seu e-mail",checkEmail:"Abra a ligação de confirmação que enviámos para verificar o seu e-mail e concluir a criação da conta.",backToLogin:"Voltar ao início de sessão",agreement:"Ao continuar, aceita os",terms:"Termos",and:"e a",privacy:"Política de Privacidade",registrationUnavailable:"O registo de contas está temporariamente indisponível. Tente mais tarde."}, nav:{overview:"Resumo",assessments:"Avaliações",properties:"Propriedades",subscriptions:"Subscrições",invoices:"Faturas",payments:"Pagamentos",profile:"Perfil",support:"Apoio",appointments:"Marcações"}, appointments:{forfeitedNote:"Esta visita venceu enquanto a fatura estava por pagar, pelo que a vez foi perdida e não é reagendada após o pagamento.",title:"Marcações",upcoming:"Próximas",past:"Anteriores",month:"Mês",agenda:"Agenda",today:"Hoje",previous:"Anterior",next:"Seguinte",empty:"Ainda não tem marcações de limpeza.",emptyUpcoming:"Não existem marcações próximas agendadas.",emptyPast:"Não existem marcações anteriores para mostrar.",allProperties:"Todas as propriedades",allStatuses:"Todos os estados",filterProperty:"Propriedade",filterStatus:"Estado",apply:"Aplicar filtros",clear:"Limpar filtros",windowLabel:"Período de serviço",windowNote:"A sua limpeza decorre durante esta semana. A hora exata é confirmada perto da data.",scheduledFor:"Agendada para",timeToBeConfirmed:"Hora a confirmar",reference:"Referência",property:"Propriedade",assignedTeam:"Equipa atribuída",teamMember:"Membro da equipa",notes:"Notas",backToList:"Voltar às marcações",details:"Detalhes da marcação",reportTitle:"Relatório de limpeza",reportPending:"O relatório de limpeza ficará disponível assim que a marcação for concluída e revista.",nextTitle:"Próxima marcação",viewAgenda:"Ver agenda",blockedNote:"O agendamento está suspenso enquanto houver um pagamento de subscrição pendente. Liquide a fatura e as suas marcações são retomadas.",states:{planning:"A agendar",confirmed:"Confirmada",in_progress:"Em curso",completed:"Concluída",cancelled:"Cancelada",awaiting_update:"A aguardar atualização",suspended:"Suspensa por fatura pendente",forfeited:"Perdida, fatura por pagar"}}, dashboard:{...en.dashboard,suspendedTitle:"Subscrições suspensas",othersContinue:"As suas outras subscrições não são afetadas e continuam normalmente.",subscriptionSuspended:"{count} subscrição suspensa até ao pagamento",subscriptionsSuspended:"{count} subscrições suspensas até ao pagamento",payNow:"Pagar agora",title:"A minha conta",welcome:"Bem-vindo de volta",accountStatus:"Estado da conta",property:"Propriedade",subscription:"Subscrição",nextPayment:"Próximo pagamento",balance:"Saldo pendente",latestInvoice:"Última fatura",upcomingService:"Próximo serviço",activity:"Atividade recente",empty:"Ainda não existem dados.",download:"Transferir",reference:"Referência",submitted:"Enviado",status:"Estado",address:"Morada",frequency:"Frequência",amount:"Montante",date:"Data",due:"Vencimento",paid:"Pago",contactSupport:"Contactar apoio"}, pause:{...en.pause}, deepClean:{...en.deepClean}, acMaintenance:{...en.acMaintenance}, properties:{...en.properties}, invoices:{...en.invoices,payNow:"Pagar agora",suspensionTermsNote:"A sua subscrição continua durante a suspensão e continua a ser faturada. Qualquer limpeza que ocorra enquanto o pagamento estiver pendente é perdida e não é reagendada após o pagamento."}, cancellation:{...en.cancellation} },
};
