...
const en: EarlyAccessCopy = {
  ...
  fields: {
    ...
    addressSearch: "Search for your address", mapsHelp: "How do I get a Google Maps link?",
...
const fr: EarlyAccessCopy = {
  ...
  fields: {
    ...
    addressSearch: "Rechercher votre adresse", mapsHelp: "Comment obtenir un lien Google Maps ?",
...
const ar: EarlyAccessCopy = {
  ...
  fields: {
    ...
    addressSearch: "ابحث عن عنوانك", mapsHelp: "كيف أحصل على رابط خرائط جوجل؟",
...
const nl: EarlyAccessCopy = {
  ...
  fields: {
    ...
    addressSearch: "Zoek uw adres", mapsHelp: "Hoe krijg ik een Google Maps-link?",
...
const es: EarlyAccessCopy = {
  ...
  fields: {
    ...
    addressSearch: "Busca tu dirección", mapsHelp: "¿Cómo obtengo un enlace de Google Maps?",
...
const de: EarlyAccessCopy = {
  ...
  fields: {
    ...
    addressSearch: "Adresse suchen", mapsHelp: "Wie erhalte ich einen Google-Maps-Link?",
...
const pt: EarlyAccessCopy = {
  ...
  fields: {
    ...
    addressSearch: "Procure a sua morada", mapsHelp: "Como obtenho uma ligação do Google Maps?",
